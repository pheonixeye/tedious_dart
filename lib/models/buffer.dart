...
class Buffer {
  ...
  //!new
  static int byteLength(dynamic value, String? encoding) {
  ...
  //!new
  Buffer slice(int size, int start, [int? end]) {
    return Buffer(size).._list.sublist(start, end);
  }

  //!new
  Buffer concat(Uint8List list, int totalSize) {
    Buffer buf = Buffer(totalSize);
    buf._list.addAll(list);
    return buf;
  }

  void copy(Buffer value, int sourceStart, [int? sourceEnd]) {
    value._list.sublist(sourceStart, sourceEnd);
  }
  ...
  void writeInt8(int integer, int position) {
    _data.setInt8(position, integer);
  }

  //!new
  void writeUInt8(int integer, int position) {
    _data.setUint8(position, integer);
  }
  ...
  //!new
  /// Writes a 16 bit [integer] to the buffer.
  void writeUInt16LE(int integer, int position) {
    _data.setUint16(position, integer, Endian.little);
  }

  //!new
  void writeInt16LE(int integer, int position) {
    _data.setUint16(position, integer, Endian.little);
  }

  //!new
  /// Writes a 16 bit [integer] to the buffer.
  void writeUInt16BE(int integer, int position) {
    _data.setUint16(position, integer, Endian.little);
    // _writePos += 2;
  }
  ...
  //!new
  /// Writes a 16 bit [integer] to the buffer.
  void writeInt16BE(int integer, int position) {
    _data.setInt16(position, integer, Endian.little);
  }
  ...
  //!new
  void writeUInt32LE(int integer, int position) {
    _data.setUint32(position, integer, Endian.little);
  }

  //!new
  writeUInt32BE(int integer, int position) {
    _data.setUint32(position, integer, Endian.little);
  }

  //!new
  writeInt32LE(int integer, int position) {
    _data.setInt32(position, integer, Endian.little);
  }

  //!new
  writeInt32BE(int integer, int position) {
    _data.setInt32(position, integer, Endian.little);
  }
  ...
  //!new
  void writeBigInt64LE(int integer, int position) {
    _data.setInt64(position, integer, Endian.little);
  }
  ...
  //!new
  void writeBigUInt64LE(int integer, int position) {
    _data.setUint64(position, integer, Endian.little);
  }
  ...
  //!new
  void writeFloatLE(double value, int position) {
    _data.setFloat32(position, value, Endian.little);
  }

  //!new
  void write(String value, int position, String? encoding) {
    value.codeUnits.map((e) {
      _data.setUint8(position++, e);
    }).toList();
  }
  ...
  //!new
  void writeDoubleLE(double value, int position) {
    _data.setFloat64(position, value, Endian.little);
  }
